                            <div class="results">
                            	<div class="results-body">
                            		<div class="results-message horiz">Monthly repayment: <span class="lg" id="payment"></span></div>
                            		...
                            		<!-- Button -->
                            		<a class="btn-apply" id="ApplyLink" href="https://apps.creditunion.co.uk/Loan/Default.aspx?amount=<?php echo $amount;?>&months=<?php echo $term;?>&product=<?php echo $product;?>&cb=<?php echo $cbond;?>">Apply for this loan </a>
									<footer class="terms">
